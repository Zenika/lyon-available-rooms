...
describe('auth.ts', () => {
    ...
    describe('getAuthenticationUrl', () => {
        it('should build the correct URL', () => {
            ...
            expect(url.searchParams.get('client_id')).toEqual('258923833211-fvmu2aq8edsogdlun6b5jv718sl2le6f.apps.googleusercontent.com')
        });
    });

    describe('parseAuthentication', () => {
        it('should store token from URL', () => {
            const token = 'ya29.a0AfB_byBE6dTpnBMQdygmoAijLzG0xJAWQn1WbK193IVEtH1olZn1PnStlMjS85wjonrHVjkauMLpF9sXzwEg3X4X_7rOa0SZWrU8MLTt_oQ10p4CXQB8JImF-PHHam1kH2B6pd1x6Ddyc2_JOrh-G225K10DB94GrlEHaCgYKAdMSARMSFQHGX2MiXh2miYQzSFDwUTOxstfoFw0171'
            const value = parseAuthentication(`state=state_parameter_passthrough_value&access_token=${token}&token_type=Bearer&expires_in=3599&scope=https://www.googleapis.com/auth/calendar.readonly`)
